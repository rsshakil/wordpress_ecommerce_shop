		...
		class FusionSC_Blog extends Fusion_Element {
			...
			public function query( $defaults ) {
				...
				if ( $fusion_query->have_posts() ) {
					while ( $fusion_query->have_posts() ) {
						...
						$element_orientation_class = fusion_library()->get_images_obj()->get_element_orientation_class( get_post_thumbnail_id(), $post_thumbnail_attachment, $defaults['blog_masonry_grid_ratio'], $defaults['blog_masonry_width_double'] );
			...
			public function loop_attr() {
				...
				if ( 'masonry' === $this->args['layout'] ) {
					...
					if ( has_post_thumbnail() ) {
						$element_orientation_class = fusion_library()->get_images_obj()->get_element_orientation_class( get_post_thumbnail_id(), [], $this->args['blog_masonry_grid_ratio'], $this->args['blog_masonry_width_double'] );
					}
			...
			public function get_featured_image_masonry() {
				...
				// Get the correct image orientation class.
				$element_orientation_class = fusion_library()->get_images_obj()->get_element_orientation_class( get_post_thumbnail_id(), $post_thumbnail_attachment, $this->args['blog_masonry_grid_ratio'], $this->args['blog_masonry_width_double'] );
				$element_base_padding      = fusion_library()->get_images_obj()->get_element_base_padding( $element_orientation_class );
